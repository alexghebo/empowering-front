    ...
    return this.each(function () {
      ...
      this.tagselect = {
        ...
        init: function () {
          ...
          _this.createElems(); // _this.showDrop();
          // $("body").unbind('click');
        ...
        showOpt: function (e) {
          ...
          ul.find('.qtagselect__field .qtagselect__placeholder').remove(); // console.log(ul.find('.qtagselect__choice').length)
          ...
          if (ul.find('.qtagselect__choice').length < settings.maxTag) {
            ...
            parent.find('.qtagselect__select').trigger('change'); // console.log(_this.attr('data-value'), parent.find('.qtagselect__select').find('option[value="1"]').text());
          } else {
        ...
        removeOpt: function (e) {
          ...
          ul.closest('.qtagselect').find('.qtagselect__select').find('option[value="' + opt.attr('data-value') + '"]').removeAttr("selected"); // parent.find('.qtagselect__select').find('option[value="' + _this.attr('data-value') + '"]').attr("selected", true);

          ul.closest('.qtagselect').find('.qtagselect__select').trigger('change'); // console.log(ul.closest('.qtagselect').find('.qtagselect__select').val(),opt.attr('data-value'));
...
//# sourceMappingURL=jquery.tagselect.js.map